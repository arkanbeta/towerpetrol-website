...
const text = {
  ar: {
    ...
    "hero.title": " شركة تاور بترول  <span class=\"accent\">للتجارة العامة والخدمات النفطية </span>",
    ...
    "about.p1": "شركة تاور بترول للتجارة العامة والخدمات النفطية تعمل في تقديم خدمات ميدانية للمشاريع النفطية، الإنشائية، الصناعية، ومشاريع المياه في العراق.",
...
"hero.title":"کۆمپانیای تاوەر پێترۆل <span class=\"accent\">بۆ بازرگانی گشتی و خزمەتگوزارییە نەوتییەکان</span>"
,    
    ...
    "about.p1": "کۆمپانیای تاوەر پێترۆل بۆ بازرگانی گشتی و خزمەتگوزارییە نەوتییەکان, خزمەتگوزاری مەیدانی پێشکەش دەکات بۆ پڕۆژەکانی نەوت، بیناسازی، پیشەسازی، و پڕۆژەکانی ئاو لە عێراق.",
...
"gallery.intro":"نمونەیەک لە کارە مەیدانییەکانی تاوەر پێترۆل ببینە، وەک ئامێری قورس، پاڵپشتی کاری هەڵکەندن کاری بۆری، گواستنەوەی ئامێر، و ئامێرە بەکارهاتووەکان لە شوێنە جیاوازەکان.", 
  ...
  en: {
    ...
    "hero.title": "Tower Petrol <span class=\"accent\">for General Trading and Oilfield Services</span>",
    ...
    "about.p1": "Tower Petrol Company for General Trading and Oilfield Services. provides field services for oilfield, construction, industrial, and water related projects in Iraq.",
